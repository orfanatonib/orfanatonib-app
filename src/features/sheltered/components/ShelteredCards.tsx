...
type Props = {
  ...
  onOpenView: (row: ShelteredResponseDto) => void;
  onStartEdit: (row: ShelteredResponseDto) => void;
  onAskDelete: (row: ShelteredResponseDto) => void;
};

export default function ShelteredrenCards(props: Props) {
  const {
